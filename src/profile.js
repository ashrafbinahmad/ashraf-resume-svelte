export default {
	about:
		'I’m an independent and passionate full stack developer, self-taught without a formal computer science degree, curious to learn more about developing scalable distributed systems, loves problem solving and cares about writing readable as well as maintainable code.',
	skillCategories: [
		{
			groupName: 'Languages/',
			skills: [
	...
	projects: [
		{
			...
			projectTechStack:
				'Nest.js, JWT, Prisma, PostgreSQL, Swagger, Validation pipelines, Multer, Next.js, Tailwind CSS, Redux, Lucide react, and ShadCN.',
